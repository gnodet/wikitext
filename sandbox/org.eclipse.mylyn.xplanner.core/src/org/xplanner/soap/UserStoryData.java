...
public class UserStoryData extends org.eclipse.mylyn.xplanner.wsdl.soap.domain.DomainData implements
	...
	public UserStoryData(int id, java.util.Calendar lastUpdateTime, double actualHours, double adjustedEstimatedHours,
			boolean completed, int customerId, java.lang.String description, java.lang.String dispositionName,
			double estimatedHours, double estimatedOriginalHours, int iterationId, java.lang.String name,
			double postponedHours, int priority, double remainingHours, int trackerId) {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		if (!(obj instanceof UserStoryData)) {
			return false;
		}
		...
		_equals = super.equals(obj)
				...
				&& ((this.dispositionName == null && other.getDispositionName() == null) || (this.dispositionName != null && this.dispositionName.equals(other.getDispositionName())))
				...
				&& this.postponedHours == other.getPostponedHours() && this.priority == other.getPriority()
				&& this.remainingHours == other.getRemainingHours() && this.trackerId == other.getTrackerId();
		__equalsCalc = null;
		return _equals;
	}
