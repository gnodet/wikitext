...
public class XPlannerServiceLocator extends org.apache.axis.client.Service implements
	...
	public XPlannerServiceLocator(java.lang.String wsdlLoc, javax.xml.namespace.QName sName)
	...
	public org.xplanner.soap.XPlanner.XPlanner getXPlanner(java.net.URL portAddress)
			throws javax.xml.rpc.ServiceException {
		try {
			org.xplanner.soap.XPlanner.XPlannerSoapBindingStub _stub = new org.xplanner.soap.XPlanner.XPlannerSoapBindingStub(
					portAddress, this);
	...
	public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
		try {
			if (org.xplanner.soap.XPlanner.XPlanner.class.isAssignableFrom(serviceEndpointInterface)) {
				org.xplanner.soap.XPlanner.XPlannerSoapBindingStub _stub = new org.xplanner.soap.XPlanner.XPlannerSoapBindingStub(
						new java.net.URL(XPlanner_address), this);
				_stub.setPortName(getXPlannerWSDDServiceName());
				return _stub;
			}
		...
		throw new javax.xml.rpc.ServiceException(
				"There is no stub implementation for the interface:  " + (serviceEndpointInterface == null ? "null" : serviceEndpointInterface.getName())); //$NON-NLS-1$ //$NON-NLS-2$
	}
