...
public class IterationData extends org.eclipse.mylyn.xplanner.wsdl.soap.domain.DomainData implements
	...
	public IterationData(int id, java.util.Calendar lastUpdateTime, double actualHours, double addedHours,
			double adjustedEstimatedHours, double daysWorked, java.lang.String description, java.util.Calendar endDate,
			double estimatedHours, java.lang.String name, double overestimatedHours, double postponedHours,
			int projectId, double remainingHours, java.util.Calendar startDate, java.lang.String statusKey,
	...
	public synchronized boolean equals(java.lang.Object obj) {
		...
		_equals = super.equals(obj)
				...
				&& ((this.endDate == null && other.getEndDate() == null) || (this.endDate != null && this.endDate.equals(other.getEndDate())))
				...
				&& ((this.statusKey == null && other.getStatusKey() == null) || (this.statusKey != null && this.statusKey.equals(other.getStatusKey())))
