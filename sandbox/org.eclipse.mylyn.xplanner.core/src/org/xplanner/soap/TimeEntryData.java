...
public class TimeEntryData extends org.eclipse.mylyn.xplanner.wsdl.soap.domain.DomainData implements
	...
	public TimeEntryData(int id, java.util.Calendar lastUpdateTime, java.lang.String description, double duration,
			java.util.Calendar endTime, int person1Id, int person2Id, java.util.Calendar reportDate,
			java.util.Calendar startTime, int taskId) {
	...
	public synchronized boolean equals(java.lang.Object obj) {
		...
		_equals = super.equals(obj)
				...
				&& ((this.endTime == null && other.getEndTime() == null) || (this.endTime != null && this.endTime.equals(other.getEndTime())))
				&& this.person1Id == other.getPerson1Id()
				&& this.person2Id == other.getPerson2Id()
				&& ((this.reportDate == null && other.getReportDate() == null) || (this.reportDate != null && this.reportDate.equals(other.getReportDate())))
				&& ((this.startTime == null && other.getStartTime() == null) || (this.startTime != null && this.startTime.equals(other.getStartTime())))
