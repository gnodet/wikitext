...
public class TaskData extends org.eclipse.mylyn.xplanner.wsdl.soap.domain.DomainData implements java.io.Serializable {
	...
	public TaskData(int id, java.util.Calendar lastUpdateTime, int acceptorId, double actualHours,
			double adjustedEstimatedHours, boolean completed, java.util.Calendar createdDate,
			java.lang.String description, java.lang.String dispositionName, double estimatedHours,
			double estimatedOriginalHours, java.lang.String name, double remainingHours, int storyId,
	...
	public synchronized boolean equals(java.lang.Object obj) {
		...
		_equals = super.equals(obj)
				...
				&& ((this.createdDate == null && other.getCreatedDate() == null) || (this.createdDate != null && this.createdDate.equals(other.getCreatedDate())))
